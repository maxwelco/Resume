...
Agronomist bridging precision farming and nature-based solutions, with expertise in field, soil health, cover crops, and data-driven land management for climate resilience. Proven expertise in agronomic R&D, arable land, crop protection, field trials, and advanced data analysis, with strong skills in statistical modeling, machine learning, and data visualization using R, Python, and other tools.
...
-   Developed precision ag tools (**OneSmartSpray**) to reduce agrochemical use—aligning with nature-based carbon strategies by minimizing farm emissions.
